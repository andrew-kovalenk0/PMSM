...
void RCC_PREDIV1Config(uint32_t RCC_PREDIV1_Source, uint32_t RCC_PREDIV1_Div)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PREDIV1_SOURCE(RCC_PREDIV1_Source));
  assert(IS_RCC_PREDIV1(RCC_PREDIV1_Div));
...
void RCC_PREDIV2Config(uint32_t RCC_PREDIV2_Div)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PREDIV2(RCC_PREDIV2_Div));
...
void RCC_PLL2Config(uint32_t RCC_PLL2Mul)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLL2_MUL(RCC_PLL2Mul));
...
void RCC_PLL3Config(uint32_t RCC_PLL3Mul)
{
  ...
  /* Check the parameters */
  assert(IS_RCC_PLL3_MUL(RCC_PLL3Mul));
...
{
  /* Check the parameters */
  assert(IS_RCC_OTGFSCLK_SOURCE(RCC_OTGFSCLKSource));
...
void RCC_ADCCLKConfig(uint32_t RCC_PCLK2)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  assert(IS_RCC_ADCCLK(RCC_PCLK2));
  tmpreg = RCC->CFGR;
...
{
  /* Check the parameters */
  assert(IS_RCC_I2S2CLK_SOURCE(RCC_I2S2CLKSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_I2S3CLK_SOURCE(RCC_I2S3CLKSource));
...
{
  /* Check the parameters */
  assert(IS_RCC_AHB_PERIPH_RESET(RCC_AHBPeriph));
  assert(IS_FUNCTIONAL_STATE(NewState));
