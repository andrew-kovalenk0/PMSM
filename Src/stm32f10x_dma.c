...
void DMA_DeInit(DMA_Channel_TypeDef* DMAy_Channelx)
{
  ...
  assert(IS_DMA_ALL_PERIPH(DMAy_Channelx));
...
FlagStatus DMA_GetFlagStatus(uint32_t DMAy_FLAG)
{
  ...
  /* Check the parameters */
  assert(IS_DMA_GET_FLAG(DMAy_FLAG));
...
{
  /* Check the parameters */
  assert(IS_DMA_CLEAR_FLAG(DMAy_FLAG));
...
{
  /* Check the parameters */
  assert(IS_DMA_CLEAR_IT(DMAy_IT));
