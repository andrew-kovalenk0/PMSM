...
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  assert(IS_TIM_LIST8_PERIPH(TIMx));
...
void TIM_ICInit(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct)
{
  ...
  {
    assert(IS_TIM_IC_POLARITY_LITE(TIM_ICInitStruct->TIM_ICPolarity));
  }
...
{ 
  /* Check the parameters */
  assert(IS_TIM_LIST9_PERIPH(TIMx));
                                ...
                                uint16_t TIM_ICPolarity, uint16_t ICFilter)
{
  /* Check the parameters */
  assert(IS_TIM_LIST6_PERIPH(TIMx));
  assert(IS_TIM_TIXCLK_SOURCE(TIM_TIxExternalCLKSource));
...
{
  /* Check the parameters */
  assert(IS_TIM_LIST7_PERIPH(TIMx));
